...
# Read train data
train_data = pd.read_csv("/home/unabila/CondGan/zen2/Alekseev.csv").values
scaler = MinMaxScaler()
...
# Read test data
test_data = pd.read_csv("/home/unabila/CondGan/zen2/Zenkevich.csv").values
Ytest = test_data[:, -1]
...
for item in configs:
    ...
    #plot_comparison(test_data,generated_data,1015,item) 

...
train_data = pd.read_csv("/home/unabila/WganCHF/bec2/Becker.csv").values
test_data = pd.read_csv("/home/unabila/WganCHF/bec2/Zenkevich.csv").values
...
print(f'Best b2z MAPE: {best_trial.value}')

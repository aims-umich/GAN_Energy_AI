...
train_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/train_m_t.csv").values
test_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/test_m_t.csv").values
...
print(f'Best mt MAPE: {best_trial.value}')

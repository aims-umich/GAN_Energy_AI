...
train_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/train_p_m.csv").values
test_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/test_p_m.csv").values
...
print(f'Best pm MAPE: {best_trial.value}')

...
train_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/train_d_m.csv").values
test_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/test_d_m.csv").values
...
print(f'Best dm MAPE: {best_trial.value}')

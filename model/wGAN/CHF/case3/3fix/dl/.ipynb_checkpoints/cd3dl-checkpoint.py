...
train_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/train_d_l.csv").values
test_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/test_d_l.csv").values
...
print(f'Best dl MAPE: {best_trial.value}')

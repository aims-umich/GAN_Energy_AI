...
train_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/train_d_p.csv").values
test_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/test_d_p.csv").values
...
print(f'Best dp MAPE: {best_trial.value}')

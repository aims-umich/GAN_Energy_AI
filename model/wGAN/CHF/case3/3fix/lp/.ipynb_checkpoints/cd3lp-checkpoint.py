...
train_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/train_l_p.csv").values
test_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/test_l_p.csv").values
...
print(f'Best lp MAPE: {best_trial.value}')

...
train_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/train_d_t.csv").values
test_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/test_d_t.csv").values
...
print(f'Best dt MAPE: {best_trial.value}')

...
train_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/train_l_t.csv").values
test_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/test_l_t.csv").values
...
print(f'Best lt MAPE: {best_trial.value}')

...
train_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/train_l_m.csv").values
test_data = pd.read_csv("/home/nabiumme/WganCHF/3fix/test_l_m.csv").values
...
print(f'Best lm MAPE: {best_trial.value}')

...
train_data = pd.read_csv("/home/unabila/WganCHF/fixed4/temp/xTemp.csv").values
test_data = pd.read_csv("/home/unabila/WganCHF/fixed4/test_all.csv").values
...
print(f'Best temp MAPE: {best_trial.value}')

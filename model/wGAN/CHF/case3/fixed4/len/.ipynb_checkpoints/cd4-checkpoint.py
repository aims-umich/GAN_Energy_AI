...
train_data = pd.read_csv("/home/nabiumme/WganCHF/fixed4/len/xLen.csv").values
test_data = pd.read_csv("/home/nabiumme/WganCHF/fixed4/test_len.csv").values
...
print(f'Best Len trial number: {best_trial.number}')
print(f'Best hyperparameters: {best_trial.params}')
print(f'Best len MAPE: {best_trial.value}')

...
train_data = pd.read_csv("/home/nabiumme/WganCHF/fixed4/mfr/xMass.csv").values
test_data = pd.read_csv("/home/nabiumme/WganCHF/fixed4/test_mass.csv").values
...
print(f'Best mass MAPE: {best_trial.value}')

...
train_data = pd.read_csv("/home/nabiumme/WganCHF/fixed4/pr/xPr.csv").values
test_data = pd.read_csv("/home/nabiumme/WganCHF/fixed4/test_pre.csv").values
...
print(f'Best Pr trial number: {best_trial.number}')
print(f'Best hyperparameters: {best_trial.params}')
print(f'Best Pr MAPE: {best_trial.value}')

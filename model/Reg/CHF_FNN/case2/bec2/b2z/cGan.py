...
train_data = pd.read_csv("/home/unabila/FFchf/bec2/Becker.csv").values
scaler = MinMaxScaler()
train_data = scaler.fit_transform(train_data)
x_train = train_data[:, :-1]
y_train = train_data[:, -1]

test_data = pd.read_csv("/home/unabila/FFchf/bec2/Zenkevich.csv").values
Y_test = test_data[:, -1]
...
final_result.to_csv('results_regressionb2z.csv', index=False)

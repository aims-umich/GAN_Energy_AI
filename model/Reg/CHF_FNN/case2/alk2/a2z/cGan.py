...
train_data = pd.read_csv("/home/unabila/CondGan/alk2/Alekseev.csv").values
scaler = MinMaxScaler()
train_data = scaler.fit_transform(train_data)
x_train = train_data[:, :-1]
y_train = train_data[:, -1]

test_data = pd.read_csv("/home/unabila/CondGan/alk2/Zenkevich.csv").values
Y_test = test_data[:, -1]
...
for item in configs:
    ...
    generated_df.to_csv(f'generated_samplesAll_{item}.csv', index=False)
...
final_result.to_csv('results_regressionALL.csv', index=False)

...
train_data = pd.read_csv("/home/unabila/CondGan/3fix/train_p_m.csv").values
scaler = MinMaxScaler()
...
# Read test data
test_data = pd.read_csv("/home/unabila/CondGan/3fix/test_p_m.csv").values
...
final_result.to_csv('results_regressionPM.csv', index=False)

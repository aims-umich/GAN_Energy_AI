...
train_data = pd.read_csv("/home/unabila/CondGan/3fix/train_d_l.csv").values
scaler = MinMaxScaler()
...
# Read test data
test_data = pd.read_csv("/home/unabila/CondGan/3fix/test_d_l.csv").values
...
final_result.to_csv('results_regressionDL.csv', index=False)

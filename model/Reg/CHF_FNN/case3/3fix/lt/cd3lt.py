...
train_data = pd.read_csv("/home/unabila/CondGan/3fix/train_l_t.csv").values
scaler = MinMaxScaler()
...
# Read test data
test_data = pd.read_csv("/home/unabila/CondGan/3fix/test_l_t.csv").values
...
final_result.to_csv('results_regressionLT.csv', index=False)

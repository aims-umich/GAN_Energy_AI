...
train_data = pd.read_csv("/home/unabila/CondGan/5h/train_500.csv").values
scaler = MinMaxScaler()
train_data = scaler.fit_transform(train_data)
x_train = train_data[:, :-1]
y_train = train_data[:, -1]

test_data = pd.read_csv("/home/unabila/CondGan/5h/test_all.csv").values
Y_test = test_data[:, -1]
...
for item in configs:
    ...
    generated_df.to_csv(f'generated_samples5h_{item}.csv', index=False)
...
final_result.to_csv('results_regression5h.csv', index=False)

...
train_data = pd.read_csv("/home/unabila/CondGan/2k/train_2k.csv").values
scaler = MinMaxScaler()
train_data = scaler.fit_transform(train_data)
x_train = train_data[:, :-1]
y_train = train_data[:, -1]

test_data = pd.read_csv("/home/unabila/CondGan/2k/test_all.csv").values
Y_test = test_data[:, -1]
...
for item in configs:
    ...
    generated_df.to_csv(f'generated_samples2k_{item}.csv', index=False)
...
final_result.to_csv('results_regression2k.csv', index=False)

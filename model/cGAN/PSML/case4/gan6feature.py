...
for feature_combination in itertools.combinations(input_features, 2):
    ...
    for i, param in enumerate(["wind power", "solar power", "load power"]):
        ...
        plt.savefig(f'prediction_gan_{feature_combination[0]}_{feature_combination[1]}_removed_{param.replace(" ", "_")}.png')
...
results_df.to_csv('gan12h_6_feature_results.csv', index=False)

...
def build_cgan(generator, discriminator):
    ...
    cgan.compile(loss=wasserstein_loss, optimizer=RMSprop())
    return cgan

def train_cgan(generator, discriminator, cgan, x_train, y_train, epochs, z_dim, batch_size, n_critic=5, clipping_value=0.01):
    ...
    for epoch in range(epochs):
        ...
        for _ in range(n_critic):
            ...
            for layer in discriminator.layers:
                ...
                weights = [np.clip(w, -clipping_value, clipping_value) for w in weights]

...
# Read train data
train_data = pd.read_csv("/home/unabila/CondGan/fixed4/dia/xDia.csv").values
scaler = MinMaxScaler()
...
# Read test data
test_data = pd.read_csv("/home/unabila/CondGan/fixed4/test_dia.csv").values
Test = test_data
Y2 = test_data[:, -2]
Ytest = test_data[:, -1]
...
final_result.to_csv('resultslb.csv', index=False)
